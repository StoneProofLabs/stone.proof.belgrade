...
export default function Page() {
  ...
  const filteredMinerals = mineralsListRefiners.filter(
    mineral =>
      mineral.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
      mineral.code.toLowerCase().includes(searchQuery.toLowerCase()) ||
      mineral.origin.toLowerCase().includes(searchQuery.toLowerCase()),
  );
      ...
      <div className="flex flex-col gap-5">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-3 justify-between">
          ...
          <div className="w-full md:w-auto md:scale-90">
            <Search onSearch={handleSearch} placeholder="Search minerals..." />
          </div>
        ...
        <div className="overflow-x-auto">
          <MineralListTable
            minerals={filteredMinerals.map(mineral => ({
              ...mineral,
              type: "raw",
