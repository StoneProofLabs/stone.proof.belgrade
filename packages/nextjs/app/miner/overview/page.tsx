      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0">
        ...
        <div className="flex flex-wrap gap-2 sm:gap-1">
          ...
          <button
            ...
            className="w-full sm:w-auto bg-[#252525] border border-[#323539] flex items-center justify-center gap-2 font-semibold px-4 py-1.5 pb-2.5 rounded-[8px] relative"
          >
            <Icon path="/dashboard/icon_set/menu.svg" alt="menu icon" />

            {isMenuOpen && (
              <div className="absolute top-full right-0 mt-2 w-48 bg-[#252525] border border-[#323539] rounded-[8px] shadow-lg z-10">
                <div className="py-1">
                  <button
                    onClick={() => handleActionClick("viewProfile")}
                    className="w-full text-left px-4 py-2 text-sm hover:bg-[#323539]"
                  >
                    View Profile
                  </button>
                  <button
